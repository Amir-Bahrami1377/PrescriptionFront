...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'renewals', name: 'renewal-list', component: () => import('@/views/customer/RenewalListView.vue') },
      { path: 'renewals/new', name: 'new-renewal', component: () => import('@/views/customer/NewRenewalView.vue') },
      { path: 'renewals/:id', name: 'renewal-detail', component: () => import('@/views/customer/RenewalDetailView.vue'), props: true },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'renewals', name: 'renewal-review-queue', component: () => import('@/views/doctor/RenewalReviewListView.vue') },
      {
        path: 'renewals/in-progress',
        name: 'renewal-in-progress',
        component: () => import('@/views/doctor/RenewalInProgressListView.vue'),
      },
