...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orders/:id/consultation', name: 'consultation-request', component: () => import('@/views/customer/ConsultationRequestView.vue'), props: true },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'consultations', name: 'consultation-queue', component: () => import('@/views/doctor/ConsultationQueueView.vue') },
